...
shinyUI(navbarPage("Fuel Economy Predictor",
                   tabPanel("Predictor",
                            sidebarLayout(
                              sidebarPanel(
                                h3('Enter details of the car'),
                                ...
                                radioButtons('am', 'Type of Transmission', c('Automatic' = '0', 'Manual' = '1')),
                                submitButton('Submit')
                              ),
                              
                              mainPanel(
                                h4('Description'),
                                p('This application developed in Shiny , predicts the fuel economy of a car (in MPG) based on the following four parameters:'),
                                tags$ul(
                                ...
                                tags$ul(
                                  ...
                                  tags$li('The predicted Fuel Economy value in MPG value will be printed in the following textbox.')
                                ),
                   ...
                   tabPanel("About",
                            mainPanel('This app was developed as part of the course project in Developing Data Products module'
                            ))
))
